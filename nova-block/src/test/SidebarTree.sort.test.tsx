 ...
 * Batch 5 · F2c · 排序契约
 *
 * 1. 默认 sortMode = 'manual',按 sort_key 排序
 * 2. 切换 updated → DOM 顺序按 updated_at desc
 * 3. 切换 created → DOM 顺序按 created_at desc
 * 4. 切换 opened → 按 openHistory.getLastOpened desc
 */
